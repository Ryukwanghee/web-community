...
public class MultipartRequest {
	 ...
	 * <p>MultipartRequest객체를 생성하면 요청 메시지를 바디부에 저장된 폼 입력값, 첨부파일을 분석하고 처리한다.
	 * <p>MultipartRequest객체를 생성하면 업로드된 첨부파일은 지정된 디렉토리에 자동으로 저장된다.
	 * 
	 * <p>폼 입력값을 MultipartRequest가 제공하는 
	 * 		String getParameter(String name), String[] getParameterValues(String name)를 이용해서 조회할 수 있따.
	 * <p>첨부파일 이름은 MultipartRequest가 제공하는
