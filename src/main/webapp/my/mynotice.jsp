...
<%
	...
	List<PostNoticeDto> postNoticeList = (List<PostNoticeDto>) postNoticeDao.getPostNoticeByEmpNo(employee.getNo());
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="list-group">
						...
						<a href="" class="list-group-item list-group-item-action active">나에게 온 알림</a>
					</div>
				</div>
				<div class="card-body">
					<div class="list-group">
