...
<%
	...
	List<Free> freeList = freeDao.getAllFree();
	for(Free free: freeList){	//writerNo부분 이름으로 바꾸기.
%>		
								<tr>
									<td><input type="checkbox" name="" value=""/></td>
									<td><%=free.getNo() %></td>
									<td><a href="" class="text-decoration-none text-dark"><%=free.getTitle() %></a></td>
									<td><%=free.getWriterNo() %></td>	 
