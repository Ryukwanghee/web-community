...
<%
	...
	param.put("empNo", loginEmployee.getNo());	//totalRows 에 값 들어가야하니까 더 위에 있어야함
...
%>
					...
					<div class="row mb-2">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control form-control-sm" name="empName" readonly="readonly" value="<%=loginEmployee.getName() %>">
						</div>
					</div>
					<div class="row mb-2">
