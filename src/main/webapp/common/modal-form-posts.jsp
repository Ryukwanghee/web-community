...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	Employee emp = (Employee)session.getAttribute("loginedEmployee");
	if(emp == null){
			...
			<div class="modal-body">
				<form class="border p-3 bg-light" action="../register.jsp" method="post" enctype="multipart/form-data">
					...
					<div class="row mb-2">
						...
						<div class="col-sm-10">						
							<input type="text" class="form-control form-control-sm" readonly="readonly" value="<%=emp.getName() %>" name="name">
						</div>
					</div>
					<div class="row mb-2">
